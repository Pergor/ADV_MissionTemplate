...
private ["_target"];
{
	...
	switch (true) do {
		case ( ADV_par_opfWeap == 1 && ADV_par_opfWeap == 2): {
			...
			_target addMagazineCargoGlobal ["rhs_mag_rdg2_black",15];
			...
			_target addMagazineCargoGlobal ["rhs_GRD40_Green",10];
			_target addMagazineCargoGlobal ["rhs_GRD40_Red",10];
		...
		case ( ADV_par_opfWeap == 3): {
			...
			_target addMagazineCargoGlobal ["CUP_1Rnd_SmokeRed_GP25_M",10];
			_target addMagazineCargoGlobal ["CUP_1Rnd_SmokeGreen_GP25_M",10];
			_target addMagazineCargoGlobal ["CUP_1Rnd_SmokeYellow_GP25_M",10];
