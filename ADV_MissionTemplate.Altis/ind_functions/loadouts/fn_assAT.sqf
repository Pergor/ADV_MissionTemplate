...
switch (ADV_par_indWeap) do {
	...
	case 2: {
		//SELmods
		_primaryweapon = ["rhs_weap_m4_carryhandle","rhs_weap_m4a1_blockII","rhs_weap_m16a4_carryhandle","rhs_weap_m16a4_grip"];
...
if (ADV_par_customWeap == 1) then { _backpack = ["backpackdummy"]; };
