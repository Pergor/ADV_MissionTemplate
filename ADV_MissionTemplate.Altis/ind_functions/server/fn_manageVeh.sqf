...
ADV_veh_support = ADV_ind_veh_Transport+ADV_ind_veh_Repair+ADV_ind_veh_Fuel+ADV_ind_veh_AirRecon;
ADV_ind_veh_AllVeh = ADV_ind_veh_Car+ADV_veh_support;
...
if ( ADV_par_indCarAssets == 99 ) then {
	[ADV_ind_veh_AllVeh,[""]] spawn ADV_ind_fnc_changeVeh;
};
