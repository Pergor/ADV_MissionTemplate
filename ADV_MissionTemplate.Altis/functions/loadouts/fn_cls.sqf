...
switch (ADV_par_customWeap) do {
	...
	case 2: {
		...
		_optic = ["rhsusf_acc_ACOG","rhsusf_acc_ACOG3","rhsusf_acc_SpecterDR_CX_3D","rhsusf_acc_SpecterDR_3d"];
...
switch (ADV_par_customUni) do {
	...
	case 3: {
		...
		_backpack = ["TFA_assault_FOL","TFA_assault_grn","TFA_assault_NWU2","TFA_assault_tan","TFA_assault_Mcam"];
	};
	case 4: {
		//TFA Woodland
