...
if (isClass (configFile >> "CfgPatches" >> "task_force_radio")) exitWith {
	...
	if ( ADV_par_Radios == 3 ) then {
		...
		_settingsSwWest set [2, ["40","41","42","43","44","45","46","47"]];
		_settingsLrWest set [2, ["50","51","52","53","54","55","56","57","58"]];

		_settingsSwEast set [2, ["40","41","42","43","44","45","46","47"]];
		_settingsLrEast set [2, ["50","51","52","53","54","55","56","57","58"]];

		_settingsSwGuer set [2, ["60","61","62","63","64","65","66","67"]];
		_settingsLrGuer set [2, ["70","71","72","73","74","75","76","77","78"]];
	};
