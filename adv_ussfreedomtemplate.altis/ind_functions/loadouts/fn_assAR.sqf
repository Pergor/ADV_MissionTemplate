...
switch (_par_indWeap) do {
	...
	case 21: {
		...
		_silencer = "";
		_additionalAmmo set [1,"150Rnd_762x54_Box_Tracer"];
		_additionalAmmo2 = nil;
	};
	default {};
};
...
switch (_par_indUni) do {
	...
	//PMC uniforms
		...
		_vest = ["V_PlateCarrier1_blk","V_PlateCarrier2_blk","V_TacVestIR_blk","V_Chestrig_blk","V_Chestrig_rgr","V_PlateCarrier1_rgr_noflag_F"];
