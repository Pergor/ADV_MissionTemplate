...
private ["_Zen_ExtendPosition", "_buildingsArray", "_buildingPosArray", "_buildingPositions", "_posArray", "_unitIndex", "_j", "_building", "_posArray", "_randomIndex", "_housePos", "_startAngle", "_i", "_checkPos", "_hitCount", "_isRoof", "_edge", "_k", "_unUsedUnits"];

params [
	["_location", [0,0,0], [[],"",objNull]]
	,["_units", ["O_Soldier_TL_F","O_Soldier_GL_F","O_Soldier_F","O_Soldier_F","O_soldier_AR_F","O_medic_F"], [[]]]
	,["_buildingRadius", 300, [0]]
	,["_putOnRoof", false, [true]]
	,["_fillEvenly", true, [true]]
];

private _center = call {
...
// 19/2/17
	//1. carefully added params-parameters.
	//2. added check for _center as either marker, object or position.
