 ...
 * or
 * [target,start,1,"B_Heli_Transport_03_F","B_LSV_01_armed_F","[_this] call adv_ai_fnc_clearCargo;[_this,false,true,2] call adv_fnc_vehicleLoad"] call adv_ai_fnc_slingloadSupply;
 *
 * Public: Yes
 */
...
//start position:
private _startPos = [_start,nil,nil,false] call adv_ai_fnc_getPos;
...
private _returnPos = if ( _veh isKindOf "PLANE" ) then {[_startPos,_targetPos,false] call adv_ai_fnc_getOppPos} else {_startPos};
