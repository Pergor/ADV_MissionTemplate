...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_HUNTER = ["B_MRAP_01_F", "B_MRAP_01_gmg_F", "B_MRAP_01_hmg_F"];
	IL_Supported_Vehicles_HMMWV = ["rc_hmmwv", "HMMWV2", "HMMWV_M1035", "M1114_AGS_ACR", "HMMWV_M1151_M2", "HMMWV2_M2", "HMMWV2_MK19", "HMMWV2_TOW", "HMMWV", "HMMWV_M2", "HMMWV_MK19", "HMMWV_TOW",
							"rhsusf_m998_w_4dr","rhsusf_m998_d_4dr","rhsusf_m998_w_s_4dr","rhsusf_m998_d_s_4dr",
							"rhsusf_m998_w_4dr_halftop","rhsusf_m998_d_4dr_halftop","rhsusf_m998_w_s_4dr_halftop","rhsusf_m998_d_s_4dr_halftop",
							"rhsusf_m998_w_4dr_fulltop","rhsusf_m998_d_4dr_fulltop","rhsusf_m998_w_s_4dr_fulltop","rhsusf_m998_d_s_4dr_fulltop",
							"rhsusf_m998_w_2dr","rhsusf_m998_d_2dr","rhsusf_m998_w_s_2dr","rhsusf_m998_d_s_2dr",
							"rhsusf_m998_w_2dr_halftop","rhsusf_m998_d_2dr_halftop","rhsusf_m998_w_s_2dr_halftop","rhsusf_m998_d_s_2dr_halftop",
							"rhsusf_m998_w_2dr_fulltop","rhsusf_m998_d_2dr_fulltop","rhsusf_m998_w_s_2dr_fulltop","rhsusf_m998_d_s_2dr_fulltop",
							"rhsusf_m1025_w_m2","rhsusf_m1025_d_m2","rhsusf_m1025_w_s_m2","rhsusf_m1025_d_s_m2",
							"rhsusf_m1025_w_mk19","rhsusf_m1025_d_Mk19","rhsusf_m1025_w_s_Mk19","rhsusf_m1025_d_s_Mk19",
							"rhsusf_m1025_w","rhsusf_m1025_d","rhsusf_m1025_w_s","rhsusf_m1025_d_s"
							];
	...
	IL_Supported_Vehicles_KAMAZ = ["I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered",
									"rhs_gaz66_msv","rhs_gaz66_vdv","rhs_gaz66_vmf","rhs_gaz66_vv","rhs_gaz66o_msv","rhs_gaz66o_vdv","rhs_gaz66o_vmf","rhs_gaz66o_vv","rhs_gaz66_r142_msv","rhs_gaz66_r142_vdv","rhs_gaz66_r142_vmf","rhs_gaz66_r142_vv","rhs_gaz66_ap2_msv","rhs_gaz66_ap2_vdv","rhs_gaz66_ap2_vmf","rhs_gaz66_ap2_vv","rhs_gaz66_repair_msv","rhs_gaz66_repair_vdv","rhs_gaz66_repair_vmf","rhs_gaz66_repair_vv",
									"rhs_ural_vmf","rhs_ural_vdv","rhs_ural_vv","rhs_ural_msv","rhs_ural_open_vmf","rhs_ural_open_vdv","rhs_ural_open_vv","rhs_ural_open_msv","RHS_Ural_Fuel_vmf_01","RHS_Ural_Fuel_vdv_01","RHS_Ural_Fuel_vv_01","RHS_Ural_Fuel_msv_01"];
	IL_Supported_Vehicles_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F",
									"rhs_typhoon_vdv"];
	IL_Supported_Vehicles_MOHAWK = ["I_Heli_Transport_02_F", "CH49_Mohawk_FG", "Marinir_CH49_Mohawk_FG", "SDC_MerlinHC3"];
	IL_Supported_Vehicles_CHINOOK = ["CH_147F", "CH_47F", "CH_47F_des", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base",
									"rhs_ch_47f_10","rhs_ch_47f_light_10","rhs_ch_47f","rhs_ch_47f_light"];
	...
	IL_Supported_KAMAZ = ["I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered",
									"rhs_gaz66_msv","rhs_gaz66_vdv","rhs_gaz66_vmf","rhs_gaz66_vv","rhs_gaz66o_msv","rhs_gaz66o_vdv","rhs_gaz66o_vmf","rhs_gaz66o_vv",
									"rhs_ural_vmf","rhs_ural_vdv","rhs_ural_vv","rhs_ural_msv","rhs_ural_open_vmf","rhs_ural_open_vdv","rhs_ural_open_vv","rhs_ural_open_msv"];
	...
	IL_Supported_Strider = ["I_MRAP_03_F", "I_MRAP_03_gmg_F", "I_MRAP_03_hmg_F", "CAF_TAPV_ar", "caf_tapv_gl_ar", "caf_tapv_50_ar", "CAF_TAPV_tw", "caf_tapv_gl_tw", "caf_tapv_50_tw", "Night_B_MRAP_03_F", "Night_B_MRAP_03_gmg_F", "Night_B_MRAP_03_hmg_F",
							"Fennek_Flecktarn","Fennek_Flecktarn_mg","Fennek_Flecktarn_gmg","Fennek_Flecktarn_san","Fennek_Tropen","Fennek_Tropen_mg","Fennek_Tropen_gmg","Fennek_Tropen_san","Fennek_Winter","Fennek_Winter_mg","Fennek_Winter_gmg","Fennek_Winter_san","Fennek_UN","Fennek_UN_san",
							"Fennek_Flecktarn_pio","Fennek_Tropen_pio"];
	...
	IL_Supported_Hummvee = ["rc_hmmwv", "HMMWV2", "HMMWV_M1035", "M1114_AGS_ACR", "HMMWV_M1151_M2", "HMMWV2_M2", "HMMWV2_MK19", "HMMWV2_TOW", "HMMWV", "HMMWV_M2", "HMMWV_MK19", "HMMWV_TOW",
							"rhsusf_m1025_w","rhsusf_m1025_d","rhsusf_m1025_w_s","rhsusf_m1025_w_s","rhsusf_m1025_w_m2","rhsusf_m1025_d_m2","rhsusf_m1025_w_s_m2","rhsusf_m1025_d_s_m2","rhsusf_m1025_w_mk19","rhsusf_m1025_d_mk19","rhsusf_m1025_w_s_mk19","rhsusf_m1025_w_s_mk19",
							"rhsusf_m998_w_s_2dr","rhsusf_m998_d_s_2dr","rhsusf_m998_w_s_2dr_halftop","rhsusf_m998_d_s_2dr_halftop","rhsusf_m998_w_s_2dr_fulltop","rhsusf_m998_d_s_2dr_fulltop","rhsusf_m998_w_s_4dr","rhsusf_m998_d_s_4dr","rhsusf_m998_w_s_4dr_halftop","rhsusf_m998_d_s_4dr_halftop","rhsusf_m998_w_s_4dr_fulltop","rhsusf_m998_d_s_4dr_fulltop"];
	...
	IL_Supported_Cargo_Veh_HUNTER = [];
	IL_Supported_Cargo_NonVeh_HUNTER = (IL_Supported_Box_H1 + IL_Supported_Box_H2);// - ["Land_WaterTank_F"];
	IL_Supported_Cargo_HUNTER = IL_Supported_Cargo_Veh_HUNTER + IL_Supported_Cargo_NonVeh_HUNTER;
	
	IL_Supported_Cargo_Veh_HMMWV = [];
	IL_Supported_Cargo_NonVeh_HMMWV = (IL_Supported_Box_H1 + IL_Supported_Box_H2);// - ["Land_WaterTank_F"];
	IL_Supported_Cargo_HMMWV = IL_Supported_Cargo_Veh_HMMWV + IL_Supported_Cargo_NonVeh_HMMWV;
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_HUNTER) then
		{
			...
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -0.65, true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 2.8, true];};
		};
		if (_obj_type in IL_Supported_Vehicles_HMMWV) then
		{
			...
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if (_obj_type in ["rhsusf_m1025_w","rhsusf_m1025_d","rhsusf_m1025_w_s","rhsusf_m1025_d_s"]) then {
				if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -1.0, true];};
				if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 1.6, true];};
			} else {
...
//	END IL_Cargo_Para
	...
	IL_Do_Load =
	{
		...
		if ((_obj_type in IL_Supported_Vehicles_HMMWV) && (_doors == "B")) then
		{
			...
			_sdist = IL_SDistL;
			if (_obj_type in ["rhsusf_m1025_w","rhsusf_m1025_d","rhsusf_m1025_w_s","rhsusf_m1025_d_s"]) then {
				_spoint = _v modelToWorld [0,-4.3,-1.6];
			} else {
				_spoint = _v modelToWorld [0,-4.3,1.6];
			};
			_box_num = _v getVariable "box_num";
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_HMMWV) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,_counter + 0.25 - _cargo_offset,_zload], [_x_cargo_offset,-3.5,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors == "B")) then
						{
...
if (_obj_main_type in IL_Supported_Vehicles_HUNTER) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_HUNTER.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
	
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on Hunter</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from Hunter</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_HMMWV) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_HMMMWV.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
	
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on HMMWV</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_HMMWV] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_NonVeh_HMMWV, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from HMMWV</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
