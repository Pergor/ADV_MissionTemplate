...
switch (ADV_par_indWeap) do {
	...
	case 2: {
		//SELmods
		_primaryweapon = ["rhs_weap_m4_m203S","rhs_weap_m4a1_carryhandle_m203S","rhs_weap_m16a4_carryhandle_M203"];
...
switch (ADV_par_indUni) do {
	...
	//AAF uniforms
		...
		if ( (ADV_par_indWeap == 1 || ADV_par_indWeap == 2) && !(ADV_par_NVGs == 1) ) then { _backpack = [""]; _40mmHeGrenadesAmmo = 10; };
	};
	case 2: {
	//TFA uniforms
