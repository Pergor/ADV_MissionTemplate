...
_backpack = ["B_AssaultPack_rgr","B_AssaultPack_dgtl"];
_insignium = "";
...
switch (_par_indUni) do {
	...
	//PMC uniforms
		...
		_vest = ["V_PlateCarrier1_blk","V_PlateCarrier1_blk","V_PlateCarrierIAGL_oli","V_PlateCarrierGL_blk"];
		...
		_backpack = ["B_Kitbag_mcamo","B_Kitbag_rgr","B_Kitbag_cbr"];
	};
	case 2: {
	//TFA uniforms
	...
	case 20: {
	//Apex Syndikat
		_uniform = ["U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F","U_I_C_Soldier_Para_4_F"];
		_vest = ["V_TacChestrig_grn_F","V_TacChestrig_cbr_F","V_TacChestrig_oli_F","V_HarnessO_brn","V_TacVest_oli","V_I_G_resistanceLeader_F"];
