...
switch (_par_customWeap) do {
	case 1: {
		...
		call {
			...
			_primaryWeapon = ["BWA3_G36A1_AG40","BWA3_G36A2_AG40","BWA3_G36A2_AG40"];
			...
			if ((toUpper worldname) in _var_aridMaps) then {
				_primaryWeapon = selectRandom ["BWA3_G36A1_AG40","BWA3_G36A1_AG40_TAN","BWA3_G36A1_AG40_TAN","BWA3_G36A2_AG40","BWA3_G36A2_AG40_TAN","BWA3_G36A2_AG40_TAN"];
...
switch (_par_customUni) do {
	case 1: {
		...
		_vest = ["BWA3_Vest_Leader_Tropen","BWA3_Vest_JPC_Leader_Tropen"];
	...
	case 2: {
		...
		_vest = ["BWA3_Vest_Leader_Fleck","BWA3_Vest_JPC_Leader_Fleck"];
		_headgear = ["BWA3_OpsCore_Schwarz"];
		if (isClass(configFile >> "CfgPatches" >> "PBW_German_Common")) then {
