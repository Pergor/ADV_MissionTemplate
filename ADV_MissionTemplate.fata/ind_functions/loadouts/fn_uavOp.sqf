...
switch (ADV_par_indWeap) do {
	...
	case 2: {
		//SELmods
		_primaryweapon = ["rhs_weap_m4_carryhandle","rhs_weap_m4_carryhandle","rhs_weap_m4_grip2","rhs_weap_m4a1","rhs_weap_m4a1_grip2"];
		_optic = ["rhsusf_acc_compm4","rhsusf_acc_compm4","rhsusf_acc_eotech_552","rhsusf_acc_ACOG"];
