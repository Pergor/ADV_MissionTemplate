...
switch (_par_customWeap) do {
	case 1: {
		...
		_itemsHandgun = [];
		_handgunSilencer = "";
		if (_special isEqualTo "AT") then { _launcher = "BWA3_Pzf3_Tandem_Loaded" };
	};
	case 2: {
		//RHS ARMY
	...
	case 5: {
		...
		if ( _par_NVGs == 1 ) then { _attachments = ["CUP_acc_Flashlight_desert"]; };
		if ( _par_NVGs == 2 ) then { _attachments = ["CUP_acc_ANPEQ_15"]; };
	...
	case 6: {
		...
		if ( _par_NVGs == 1 ) then { _attachments = ["CUP_acc_Flashlight"]; };
		if ( _par_NVGs == 2 ) then { _attachments = ["CUP_acc_ANPEQ_2_grey"]; };
...
switch (_par_customUni) do {
	case 1: {
		...
		_vest = ["BWA3_Vest_Rifleman_Tropen","BWA3_Vest_JPC_Rifleman_Tropen"];
	...
	case 2: {
		...
		_vest = ["BWA3_Vest_Rifleman_Fleck","BWA3_Vest_JPC_Rifleman_Fleck"];
