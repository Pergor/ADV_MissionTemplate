...
//Addon Content:
switch (true) do {
	case (_par_customWeap isEqualTo 1): {
		//BWmod
		_primaryweapon = "";
		_optic = [""];
		_attachments = [""];
		...
		_itemsHandgun = [""];
		_handgunSilencer = "";		//if silencer is added
		_handgunAmmo set [0,3];
	};
	case (_par_customWeap isEqualTo 2 || _par_customWeap isEqualTo 3): {
		//SELmods
		_primaryweapon = "";
		_optic = [""];
		_attachments = [""];
		...
		if (_par_customWeap isEqualTo 3) then { _handgun = "rhsusf_weap_m1911a1"; };
		_itemsHandgun = [""];
		_handgunSilencer = "";
	};
	case (_par_customWeap isEqualTo 4): {
		//SELmods
		_primaryweapon = "";
		_optic = [""];
		_attachments = [""];
	...
	case (_par_customWeap isEqualTo 5 || _par_customWeap isEqualTo 6): {
		//CUP
		_primaryweapon = "";
		_optic = [""];
		_attachments = [""];
	...
	case (_par_customWeap isEqualTo 7): {
		//CUP BAF
		_primaryweapon = "";
		_optic = [""];
		_attachments = [""];
	...
	case (_par_customWeap isEqualTo 8): {
		//UK3CB
		_primaryweapon = "";
		_optic = [""];
		_attachments = [""];
	...
	case (_par_customWeap isEqualTo 9): {
		//HLC
	...
	case (_par_customWeap isEqualTo 20): {
	};
	default {};
};
switch (true) do {
