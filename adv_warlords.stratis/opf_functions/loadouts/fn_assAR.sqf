...
switch (_par_opfWeap) do {
	case 1: {
		...
		_itemsHandgun = [];
		_handgunSilencer = "";
		_additionalAmmo = [3,"rhs_100Rnd_762x54mmR",true];
		_additionalAmmo2 = [2,"rhs_100Rnd_762x54mmR_green",true];		
	};
	case 2: {
		//RHS Guerilla
	...
	case 3: {
		...
		_additionalAmmo = [5,"CUP_100Rnd_TE4_LRT4_762x54_PK_Tracer_Green_M",true];
