 ...
 *
 * Example:
 * [player] call adv_opf_fnc_diver_medic;
 *
 * Public: No
 */
...
_ace_FAK = 2;		//overwrites the values for bandages, morphine and tourniquet and adds a specified number of bandages and morphine. Defined in fn_aceFAK.sqf
