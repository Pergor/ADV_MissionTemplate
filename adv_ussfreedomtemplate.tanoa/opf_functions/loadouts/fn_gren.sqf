...
_optic = ["optic_ARCO","optic_ARCO","optic_ACO_grn","optic_Holosight"];
_attachments = [""];
...
switch (_par_opfUni) do {
	case 1: {
		...
		_vest = ["rhs_6b23_digi_6sh92_vog","rhs_6b13_Flora_6sh92_vog","rhs_6b13_6sh92_vog"];
	...
	case 2: {
		...
		_vest = ["rhs_6b13_Flora_6sh92_vog","rhs_6b13_6sh92_vog"];
	...
	case 20: {
		...
		if ( _par_opfWeap > 0 ) then { _backpack = ["B_AssaultPack_rgr"]; };
