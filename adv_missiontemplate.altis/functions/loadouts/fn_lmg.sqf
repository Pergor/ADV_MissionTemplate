...
_backpack = [""];
if ( _par_NVGs > 0 ) then { _backpack = ["B_AssaultPack_dgtl","B_AssaultPack_khk","B_AssaultPack_rgr","B_AssaultPack_cbr","B_AssaultPack_mcamo"]; };
_insignium = "";
...
switch (_par_customUni) do {
	...
	case 20: {
		...
		if ( _par_NVGs > 0 ) then { _backpack = ["B_AssaultPack_tna_F"]; };
