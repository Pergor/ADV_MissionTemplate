...
//clothing - (string)
_uniform = ["U_Marshal","U_C_Journalist","U_Rangemaster"];
_vest = ["V_Press_F"]; 
_headgear = ["H_Cap_press","","",""];
_backpack = [""];
_insignium = "";
...
//MarksmenDLC-objects:
if ( (304400 in (getDLCs 1) || 332350 in (getDLCs 1)) && (missionNamespace getVariable ["_par_DLCContent",1]) > 0 ) then {
};
...
//scorch inv items
_scorchItems = ["sc_passport","sc_files","sc_iphone","sc_wallet"];
_scorchItemsRandom = ["sc_cigarettepack","sc_chips","sc_charms","sc_candybar","sc_usbdrive","","",""];
