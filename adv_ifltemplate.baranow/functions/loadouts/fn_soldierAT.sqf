...
//clothing - (string)
_uniform = ["U_LIB_GER_Oberschutze","U_LIB_GER_Schutze","U_LIB_GER_Recruit"];
_vest = ["V_LIB_GER_VestKar98"];
_headgear = ["H_LIB_GER_Helmet"];
...
_primaryweaponAmmo = [12,0];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
...
_grenades = ["HE","HE","WHITE"];			//depending on the custom loadout the colours may be merged. add like this: ["HE","HE","WHITE"] (adds two HE and one white smoke grenade).
