...
_backpack = ["B_LIB_GER_Panzer_Empty"];
_insignium = "";
...
_launcherAmmo = [4,0];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
