zbe_aiCacheDist				= [_this, 0, 1000] call BIS_fnc_param;
zbe_minFrameRate			= [_this, 1, -1] call BIS_fnc_param;
zbe_debug					= [_this, 2, false] call BIS_fnc_param;
zbe_vehicleCacheDistCar		= [_this, 3, 100] call BIS_fnc_param;
zbe_vehicleCacheDistAir		= [_this, 4, 1000] call BIS_fnc_param;
zbe_vehicleCacheDistBoat	= [_this, 5, 1000] call BIS_fnc_param;
