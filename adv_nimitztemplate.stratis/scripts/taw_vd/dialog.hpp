...
class TAWVD_RscShortcutButton {
	...
	soundPush[] = {"\A3\ui_f_data\Sound\RscButton\soundPush",0.09,1};
	soundClick[] = {"\A3\ui_f_data\Sound\RscButton\soundClick",0.09,1};
	soundEscape[] = {"\A3\ui_f_data\Sound\RscButton\soundEscape",0.09,1};
	action = "";
	class Attributes
	{
		font = "PuristaMedium";
...
class TAWVD_RscButtonMenu : TAWVD_RscShortcutButton {
	...
	soundEnter[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundEnter",0.09,1};
	soundPush[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundPush",0.09,1};
	soundClick[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundClick",0.09,1};
	soundEscape[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundEscape",0.09,1};
	textureNoShortcut = "";
};
...
class TAWVD_activeText 
{
	...
	soundEnter[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundEnter", 0.09, 1};
	soundPush[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundPush", 0.0, 0};
	soundClick[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundClick", 0.07, 1};
	soundEscape[] = {"\A3\ui_f_data\sound\RscButtonMenu\soundEscape", 0.09, 1};
	action = "";
	text = "";
};
