...
_goggles = "";
_unitTraits = [["medic",false],["engineer",true],["explosiveSpecialist",false],["UAVHacker",true],["camouflageCoef",1.0],["audibleCoef",1.0]];
...
switch (ADV_par_opfUni) do {
	case 1: {
		...
		//"rhs_uniform_mflora_patchless","rhs_uniform_flora_patchless"
		_vest = ["rhs_6b23_digi_6sh92_radio","rhs_6b23_6sh92_radio"];
		//"rhs_6b23_digi_6sh92_headset","rhs_6b23_digi_6sh92_headset_mapcase","rhs_6b23_digi_6sh92_radio","rhs_6b23_digi_6sh92_vog","rhs_6b23_digi_6sh92_vog_headset"
		_headgear = ["rhs_6b27m_green","rhs_6b27m_green_bala","rhs_6b27m_digi","rhs_6b27m_digi_bala","rhs_6b27m","rhs_6b27m_bala","rhs_6b28_green","rhs_6b28_green_bala","rhs_6b28","rhs_6b28_bala","rhs_6b28_flora","rhs_6b28_flora_bala"];
		//"rhs_rpg_empty","rhs_sidor","rhs_assault_umbts","rhs_assault_umbts_engineer","B_FieldPack_oli","B_Kitbag_sgg","B_TacticalPack_oli","B_Carryall_oli","B_AssaultPack_sgg"
	};
	case 2: {
		//RHS Flora
	...
	case 3: {
		...
		_vest = ["rhs_6b23_ML_6sh92_radio","rhs_6b23_6sh92_radio"];
