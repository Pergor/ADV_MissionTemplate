...
switch (ADV_par_customUni) do {
	...
	case 3: {
		//TFA Mixed
		_uniform = ["TFA_BDU_MCAM_RS","TFA_BDU_NWU2_RS","TFA_MCAM_BDU_RS","TFA_MCAM_NWU2_RS","TFA_MCAM_NWU3_RS","TFA_NWU2_MCAM_RS","TFA_NWU2_BDU_RS","TFA_NWU2_NWU3_RS","TFA_NWU3_MCAM_RS","TFA_NWU3_NWU2_RS"];
