...
switch (ADV_par_customWeap) do {
	...
	case 3: {
		...
		_optic = ["rhsusf_acc_compm4","rhsusf_acc_eotech_552","rhsusf_acc_eotech_552","rhsusf_acc_ACOG","rhsusf_acc_ACOG3"];
		if ( ADV_par_NVGs == 1 ) then { _attachments = ["rhsusf_acc_M952V"]; };
		if ( ADV_par_NVGs == 2 ) then { _attachments = ["rhsusf_acc_anpeq15side_bk"]; };
		_silencer = "rhsusf_acc_rotex5_grey";
		_primaryweaponAmmo set [1,9];
	...
	case 5: {
		...
		_primaryweaponAmmo set [1,9];
		_additionalAmmo = [2,"CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M",true];
		_additionalAmmo2 = [2,"CUP_100Rnd_TE4_LRT4_White_Tracer_762x51_Belt_M",true];
	...
	case 8: {
		...
		_additionalAmmo = [2,"UK3CB_BAF_75Rnd",true];
		_additionalAmmo2 = [3,"UK3CB_BAF_75Rnd_T",true];
...
switch (ADV_par_customUni) do {
	...
	case 3: {
		...
		_backpack = ["TFA_Kitbag_Tan","TFA_Kitbag_MCam","TFA_Kitbag_Grn"];
	};
	case 4: {
		//TFA Woodland
	...
	case 5: {
		...
		_backpack = ["TFA_Kitbag_NWU2","TFA_Kitbag_tan","TFA_Kitbag_Mcam"];
	};
	case 6: {
		//TFA ACU
