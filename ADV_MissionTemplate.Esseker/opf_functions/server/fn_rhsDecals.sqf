...
switch true do {
	case (_veh isKindOf "rhs_tigr_base"): {
		...
		[_veh,[["Label", [6,7,8], "Army", [19,0]]]] spawn rhs_fnc_decalsInit;
	};
	case (_veh isKindOf "rhs_gaz66_vmf" || _veh isKindOf "RHS_Ural_BaseTurret" || _veh isKindOf "RHS_UAZ_Base"): {
		[_veh,[["Number", [2,3,4,5], "Default",0537]]] spawn rhs_fnc_decalsInit;
		[_veh,[["Label", [6,7], "Army", [19,0]]]] spawn rhs_fnc_decalsInit;
	};
	case (_veh isKindOf "rhs_btr_base"): {
		[_veh,[["Number", [9,10,11], "DefaultRed",537]]] spawn rhs_fnc_decalsInit;
		[_veh,[["Label", [2,3,4,6,7,8], "Army", [19,0]]]] spawn rhs_fnc_decalsInit;
	};
	...
	case (_veh isKindOf "rhs_a3t72tank_base" || _veh isKindOf "rhs_tank_base") : {
		[_veh,[["Number", [0,1,2], "DefaultRed",537]]] spawn rhs_fnc_decalsInit;
	};
	...
	case (_veh isKindOf "rhs_a3spruttank_base") : {
		[_veh,[["Number", [0,1,2], "DefaultRed",537]]] spawn rhs_fnc_decalsInit;
		[_veh,[["Label", [3], "Army", [19,0]]]] spawn rhs_fnc_decalsInit;
	};
